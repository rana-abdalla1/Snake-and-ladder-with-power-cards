...
public:
	...
	Player* GetNextPlayer(Player*p1) ;
	...
	Player* GetPoorest();
	Card* copycard(CellPosition pos);//will return NULL if has no card
	void resetAllPlayers();
	void SaveAll(ofstream&, Type LADDER);
	void resetAllCities();
	void DecreaseCurrentPlayer();

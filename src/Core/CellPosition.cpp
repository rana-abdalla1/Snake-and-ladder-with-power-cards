...
int CellPosition::GetCellNumFromPosition(const CellPosition& cellPosition)
{
	...
	{
		v = (NumVerticalCells - 1) - cellPosition.vCell;
		num = (v * NumHorizontalCells) + (cellPosition.hCell + 1);
	}
	else
	{
		num = -1;
...
CellPosition CellPosition::GetCellPositionFromNum(int cellNum)
{
	...
	if (cellNum >= 1 && cellNum <= 99)
	{
		...
		{
			v = NumVerticalCells - (cellNum / NumHorizontalCells);
			h = NumHorizontalCells - 1;
		}
		else
		{
...
void CellPosition::AddCellNum(int addedNum)
{
	...
	/// TODO: Implement this function as described in the .h file
	int num = GetCellNumFromPosition(*this);

	(*this) = GetCellPositionFromNum(num + addedNum);
